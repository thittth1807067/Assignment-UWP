...
namespace Assignment3110
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void NavView_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            NavView_Navigate("information", new EntranceNavigationTransitionInfo());
        ...
        private async void LoadCurrentLoggedIn(object sender, RoutedEventArgs e)
        {
            ...
            if (memberCredential != null)
            {
                ...
                Debug.WriteLine(ProjectConfiguration.CurrentMemberCredential.token);
            }
        }
